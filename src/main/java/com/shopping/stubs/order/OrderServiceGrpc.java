...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.shopping.stubs.order.OrderRequest,
      com.shopping.stubs.order.OrderResponse> getGetOrdersForUserMethod;
  ...
  public static io.grpc.MethodDescriptor<com.shopping.stubs.order.OrderRequest,
      com.shopping.stubs.order.OrderResponse> getGetOrdersForUserMethod() {
    io.grpc.MethodDescriptor<com.shopping.stubs.order.OrderRequest, com.shopping.stubs.order.OrderResponse> getGetOrdersForUserMethod;
    if ((getGetOrdersForUserMethod = OrderServiceGrpc.getGetOrdersForUserMethod) == null) {
     ...
     return getGetOrdersForUserMethod;
  }
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    public void getOrdersForUser(com.shopping.stubs.order.OrderRequest request,
      ...
      asyncUnimplementedUnaryCall(getGetOrdersForUserMethod(), responseObserver);
    }
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public com.shopping.stubs.order.OrderResponse getOrdersForUser(com.shopping.stubs.order.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.shopping.stubs.order.OrderResponse> getOrdersForUser(
  ...
  private static final int METHODID_GET_ORDERS_FOR_USER = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ORDERS_FOR_USER:
          serviceImpl.getOrdersForUser((com.shopping.stubs.order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.shopping.stubs.order.OrderResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.shopping.stubs.order.OrderOuterClass.getDescriptor();
    }
      ...
      synchronized (OrderServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetOrdersForUserMethod())
              .build();
        }
      }
    }
